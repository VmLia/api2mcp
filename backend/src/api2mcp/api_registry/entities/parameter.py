...
class Api2mcpParameter(Base):
    ...
    baseinfo_id = Column(String, ForeignKey("api2mcp_baseinfo.id"), nullable=False)  # 修改：tool_id → baseinfo_id
    ...
    # 关系 - 修改：tool → baseinfo
    baseinfo = relationship("Api2mcpBaseinfo", back_populates="parameters")
